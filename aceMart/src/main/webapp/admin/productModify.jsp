...
<body>
 ...
 <div class="container-fluid">
     <div class="row">
         <div class="col-md-12">
             <div class="card">
             <form:form modelAttribute="product" action="../product/update.html" 
              method="post" enctype="multipart/form-data">
                 <div class="card-header" data-background-color="purple">
                     <h4 class="title">상품 정보 수정</h4>
                     <p class="category"></p>
                 </div>
                 <div class="card-body">
                 <div class="row">
        			 ...
        			 <div class="col-md-7">
                             ...
                             <div class="col-md-4">
                                 <div class="form-group label-floating">
                                     <label class="form-text">브랜드</label>
										...
										<c:choose>
											<c:when test="${product.p_brand==br }">
												<option selected="selected">${br}</option>
											</c:when>
											<c:otherwise>
												<option>${br}</option>
											</c:otherwise>
                             ...
                             <div class="col-md-4">
                                 <div class="form-group label-floating">
                                     <label class="form-text">분류</label>
										...
										<c:choose>
											<c:when test="${product.p_type==tp }">
												<option selected="selected">${tp}</option>
											</c:when>
											<c:otherwise>
												<option>${tp}</option>
											</c:otherwise>
                         ...
                         <div class="col-md-2">
                            <div class="form-group label-floating">
		                         <button id="size-add" class="btn btn-fab btn-fab-mini btn-round btn-rose">+</button>
		                    </div>
                         </div>
                       </div>
					</div>
                    <div class="col-md-5">
						 <div class="fileinput fileinput-new text-center" data-provides="fileinput">
						   ...
						   <c:if test="${product.p_image1!=null}">
							<img src="../upload/${product.p_image1}" alt="...">
						  </c:if>
						   </div>
...
// 		 }
// 	});
	$('.fileinput-etc').prepend('<img class="imageThumb" src="../upload/'+'${product.p_image2}'+'"/>');
	$('.fileinput-etc').prepend('<img class="imageThumb" src="../upload/'+'${product.p_image3}'+'"/>');
