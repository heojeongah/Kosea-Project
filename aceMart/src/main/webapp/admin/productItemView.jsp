         ...
         <div class="col-md-12">
             <div class="card">
                    ...
                    <div class="col-md-5">
						 <div class="fileinput fileinput-new text-center" data-provides="fileinput">
						   <div class="fileinput-new thumbnail img-raised">
							<img src="../upload/${PRODUCT_ITEM.p_image1 }" alt="...">
						   	</div>
						    <div class="fileinput-preview fileinput-exists thumbnail img-raised"></div>
													<img class="fileinput-etc" src="../upload/${PRODUCT_ITEM.p_image2 }" alt="...">
								<img class="fileinput-etc" src="../upload/${PRODUCT_ITEM.p_image3 }" alt="...">
		
							<div class="fileinput-etc">
						   </div>
						</div>
                    </div>
                    </div>
				...
				<div class="card-footer">
                    <a href="../product/updateForm.html?p_code=${PRODUCT_ITEM.p_code }" class="btn btn-primary pull-right">수정</a>
                    <a href="../product/delete.html?p_code=${PRODUCT_ITEM.p_code }" class="btn btn-danger pull-right" >삭제</a>
